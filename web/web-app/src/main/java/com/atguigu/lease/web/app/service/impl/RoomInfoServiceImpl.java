...
public class RoomInfoServiceImpl extends ServiceImpl<RoomInfoMapper, RoomInfo>
    ...
    public RoomDetailVo getDetailById(Long id) {
        ...
        //保存浏览历史
        browsingHistoryService.saveBrowsingHistory(LoginUserHolder.getLoginUser().getUserId(),id);
    ...
    @Override
    public IPage<RoomItemVo> pageRoomItemVoByApartmentId(Page<RoomItemVo> page, Long id) {
